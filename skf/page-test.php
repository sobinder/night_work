...
<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
							...
							<input type="zip" name="codezip" id="codezip" placeholder="Zip Code">
							<select type="text" id="codeziplocation" name="codeziplocation">
							  <option>---</option>
							</select>
...
'inlineDirections':false,
	...
	jQuery(document).on('change', '#codezip', function() {
		console.log('chanfgdge #codezip');
	   jQuery('input#bh-sl-address').val(jQuery(this).val());
		jQuery('form#bh-sl-user-location').submit();
		jQuery("#codeziplocation").find('option').remove();
		jQuery("#codeziplocation").addClass("loading");
		setTimeout(function() {
			jQuery("ul.list option:lt(5)").each(function(i) {
				jQuery(this).clone().appendTo("#codeziplocation");
				jQuery("#codeziplocation").removeClass("loading")
			})
		},2000)
	});
...
<script type='text/javascript' src='https://skykingfireworks.com/wp-content/themes/skf/store/assets/js/libs/handlebars.min.js' id='handlebars-js4'></script>
<script type='text/javascript' src='https://skykingfireworks.com/wp-content/themes/skf/store/assets/js/plugins/storeLocator/jquery.storelocator.js' id='store-locator-js2'></script>
<script type='text/javascript' src='https://skykingfireworks.com/wp-content/themes/skf/store/assets/js/plugins/storeLocator/customs.js' id='store-cs-js2'></script>
<?php } ?>
