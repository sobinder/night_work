...
.catalog p {padding:0 !important;}
</style>

<div class="parallax-window" data-parallax="scroll" data-image-src="<?php the_field('parallax_background');?>">
<div class="section catalog clearfix" style="margin-top:30px;width: 100%;max-width: 888px; margin-left: auto;margin-right: auto;">
<div class="container">
<div class="row">
...
<option value="{{email}}">{{name}} {{distance}} {{length}}</option>
{{/location}}
</script>
