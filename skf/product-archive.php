...
$thumbnail = get_field('header_image', $queried_object);

// load thumbnail for this taxonomy term (term string)
$thumbnail = get_field('header_image', $taxonomy . '_' . $term_id);
$title = get_field('header_text', $taxonomy . '_' . $term_id);
?>


<section class="page-banner bg-image" style="background:url(<?php echo $thumbnail;?>) no-repeat center center;">
			<div class="container">
				<div class="row">

					<div class="col-md-12">
						<div class="title">
                        <?php if( get_field('header_text', $taxonomy . '_' . $term_id) ) { ?> <h1><?php echo woocommerce_page_title();?></h1><?php echo the_field('header_text', $taxonomy . '_' . $term_id);?><?php } else { ?>
